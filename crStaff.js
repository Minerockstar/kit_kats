const customer_Schema = require("./CreatstaffSche")

const get_customerc= async(req, res)=>{
    const find = await customer_Schema.find({})
    res.json(find)
}
const post_customerc= async(req, res)=>{
...
const update_customerc = async(req, res)=>{
...
const delete_customerc = async(req, res)=>{
...
module.exports = {get_customerc, post_customerc, update_customerc, delete_customerc}