...
const Stdview = () => {
  const [showSidebar, setShowSidebar] = useState(false);
    ...
    const [viewStd, setStdview] = useState(false);
    ...
    const handleViewStd = () => {
      ...
      setStdview(true); // Show details when "View Employee" is clicked
    };
  ...
  return (
    <div className={`wrapper ${showSidebar ? 'sidebar-collapse' : ''}`}>
      ...
      <div className="content-wrapper">
        {
        currentContent === 'viewstd' ? < ViewStd/> :
