...
const RescheRead = () => {
  ...
  return (
   ...
   <div className='stdlistboby'>
    <span className='iospro' ><IoIosPeople /> Add Leads</span>
    <span className='registerstdlist'>Reschedule Leads</span> 
    <p>Leads Info <IoIosArrowForward /> Reschedule List</p>
   </div>
   </div>
<div>
